...
if ($conn->connect_error) {
   ...
   $select_query = "SELECT question FROM userq WHERE \'답변여부\'=\'답변대기중\'";
   $result_set = mysqli_query($conn, $select_query);
   $question = mysqli_num_rows($result_set);
...
<head>
    ...
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="img/graffitiicon.png">
    <!-- Google Fonts
		============================================ -->
        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
                                        <a href="#"><img src="data:image/png;base64," alt=""/></a>
                                        <h2><?php echo"$id"?></h2>
				</div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="admin main" href="index.php"><span class="mini-sub-pro">관리자메인페이지</span></a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                <h4 class="text-left text-uppercase"><b>미답변 문의</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    <div class="col-xs-3 mar-bot-15 text-left">
                                        <label class="label bg-green"></label>
                                    </div>
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        <h2 class="text-right no-margin"><?php echo $question ?></h2>
                                    </div>
                                </div>
